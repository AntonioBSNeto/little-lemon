...
export const Hero = () => {
  ...
  return (
    <section className="bg-primary-green bg-gradient-to-b from-100% sm:from-75% to-75% from-primary-green to-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between py-8 md:py-10">
          <div className="w-full md:w-1/2 text-center md:text-left mb-8 md:mb-auto">
            ...
            <p className="text-gray-100 font-karla text-lg md:text-xl max-w-md mb-8 font-semibold mx-auto md:mx-0">
          ...
          <div className="w-full md:w-1/2 flex justify-center md:justify-end">
            <div className="relative max-w-[350px] max-h-[370px] rounded-lg overflow-hidden">
              <img
                src="src\assets\restauranfood.webp"
                alt="Mediterranean appetizers"
                className="h-auto rounded-lg shadow-lg object-cover hidden sm:block"
                rel="preload"
              />
            </div>
          </div>
