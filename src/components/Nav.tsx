...
export const Nav = () => {
  ...
  return (
    <nav className="hidden sm:ml-6 md:flex sm:space-x-8 font-karla">
      ...
      <div aria-label="On Click" className="text-gray-900 hover:bg-gray-50 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-semibold content-center cursor-pointer">
        About
      </div>
      <div aria-label="On Click" className="text-gray-900 hover:bg-gray-50 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-semibold content-center cursor-pointer">
        Menu
